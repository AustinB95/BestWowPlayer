...
const friends = [`kelly`, `Danny`, `Erica`, `fred`]
friends[1] = `NotDanny`
friends.push(`Peter`)
friends.pop();
friends.shift()
console.log(friends)
console.log(friends.indexOf(`Erica`))
 
console.log(friends.includes(`Erica`))

if (friends.includes('Erica')) {
    console.log(`Erica is invited to the grp`);
} else {
    console.log(`Nope, erica is not a friend`);
}
...
// Array order matters, Object data is retrieved by name
const jonas = {
    firstName: `jonas`,
    lastName: `Sagget`,
    friends: [`bob`, `jill`],
    ...
    dLicense: function(){
        this.age >= 16 ? (this.license = `a` ) : (this.license =`no`) ;
        return this.license;
    },
    getSummary: function(){
        return `${this.firstName} is a ${this.calcAge()}-year old ${this.job} 
        and he has ${this.license} Drivers License.`;
...
// an object is a const that has an array. a Method is a Function in an object
